                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                           Text("Reward",style: TextStyle(color: white,fontWeight: FontWeight.bold,fontSize: 16),),
                            SizedBox(
                              height: height * 0.02,
                            ),
                             Stack(
                               children: [
                                 Image(image: AssetImage('assets/icons/08Usdt.png'),height: 120,),
                                 Positioned(
                                   top: 60,
                                   left: 35,
                                   child:Text("\$ 5",style: TextStyle(color: white,fontSize: 40,fontWeight: FontWeight.bold),),),
                               ],
                             ),
                            SizedBox(
                              height: height * 0.02,
